#!/usr/bin/env python3
"""Snapshot every previously structured source URL/SHA before Wave243A."""
...
OUTPUT = ROOT / "docs/audits/generated/rb-wave243a-prior-source-exclusions.json"
URL_KEYS = {"source_url"}
...
def main() -> None:
    ...
    candidates = sorted({path for path in candidates if "wave243a" not in path.name.lower()})
    ...
    payload = {
        "schema_version": 1,
        "wave": "wave243a_prior_source_exclusions",
